...
public class PlaceCateDAO extends AbstractDAO {
	...
	public List<Map<String, Object>> cateSelectList(Map<String, Object> map) throws Exception{
		return selectList("place_cate.se_pl_cate_list", map);
	}
	
	/** 23.01.17 나슬기: 시설 카테고리 추가 메소드 */
	public int cateInsert(Map<String, Object> map) throws Exception{
		return Integer.parseInt(insert("place_cate.in_pl_cate", map).toString());
	}
	
	/** 23.01.17 나슬기: 시설 카테고리 수정 메소드 */
	public int cateUpdate(Map<String, Object> map) throws Exception{
	...
	public int cateDelete(Map<String, Object> map) throws Exception{
		return Integer.parseInt(delete("place_cate.de_pl_cate", map).toString());
	}
}