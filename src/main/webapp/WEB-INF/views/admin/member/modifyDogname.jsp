    ...
    <div class="container mx-auto mt-24 sm:px-6 lg:px-8">
        <div class="space-y-8 divide-y divide-gray-200 max-w-screen-lg">
            <div class="space-y-6 sm:space-y-5">
                <div>
                    <h3 class="text-lg font-medium leading-6 text-gray-900">견종이름수정</h3>
                </div>
            </div>

            <form class="space-y-8 divide-y divide-gray-200 max-w-screen-lg" action="/admin/modifyDogname" method="POST">
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:pt-5">
                                ...
                                <div class="mt-1 sm:mt-0">
                                    <input type="text" name="BR_NAME" id="BR_NAME" maxlength="36" autocomplete=""
                                           class="block w-full max-w-lg rounded-md shadow-sm focus:border-[#f08080] focus:ring-[#f08080] sm:max-w-xs sm:text-sm" value="${BR_NAME}">
                                    <p class="mt-2 text-sm text-red-600" id="dogname-error"></p>
                                </div>
                            </div>
                        </div>
                        <input type="hidden" id="BR_IDX" name="BR_IDX" value="${BR_IDX}" readonly>
