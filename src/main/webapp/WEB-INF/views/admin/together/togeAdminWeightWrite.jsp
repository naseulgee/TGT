...
function wtwriteform_check(){
	...
	document.wtwritefrm.submit();//값 넘겨주기
}
</script>
<style>
span.fa-solid {
...
<form method="post" action="/admin/together/weightwrite" name="wtwritefrm">
	<table class="board_view">
		...
		<tbody>
			<tr>
				<td class="txt_center"><input type="text" id="WT_START" name="WT_START" placeholder="입력해주개:)"/></td>
				<td class="txt_center">~</td>
				<td class="txt_center"><input type="text" id="WT_END" name="WT_END" placeholder="입력해주개:)"/></td>
			</tr>
		</tbody>
	</table>
	<br/>
